    ...
    <div className='desktop-container'>
        <div className='desktop-top'>
            ...
            <a href="https://www.linkedin.com/in/viera-daniel" target="_blank" rel="noopener noreferrer">
                <img src="/src/assets/icons/linkedin.png" alt="img"  className='app-icon'/>
            </a>
            
            <img src="/src/assets/icons/folder.png" alt="img"  className='app-icon'/> 

            <a href="https://github.com/vieradaniel" target="_blank" rel="noopener noreferrer">
                <img src="/src/assets/icons/github.png" alt="img"  className='app-icon'/>
            </a>
